        ...
        <div class="space-y-8">
            ...
            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                ...
                <div class="flex flex-col sm:flex-row w-full sm:w-auto items-stretch sm:items-center gap-3">
                    <SearchInput v-model="searchQuery" @search="handleSearch" @clear="handleSearch" placeholder="Cari review..." />
                </div>
            </div>
...
const handleSearch = () => {
    router.get('/admin/reviews', buildParams(), { preserveState: true, replace: true });
};
